...
public class JsonElementTest {
     ...
     * 
     * @throws NoSuchElementException unwanted.
     */
    @Test
    public void testObjectGetString() throws NoSuchElementException {
     ...
     * Tests the getString() method {@link JsonObject}.
     * 
     * @throws NoSuchElementException wanted.
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetStringNoKey() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetStringWrongType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test
    public void testObjectGetBoolean() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetBooleanNoKey() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetBooleanWrongType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
        obj.putElement("a", new JsonNumber(2));
     ...
     */
    @Test
    public void testObjectGetInt() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetIntNoKey() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetIntWrongType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetIntWrongNumberType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test
    public void testObjectGetLong() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
        obj.putElement("a", new JsonNumber(4));
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetLongNoKey() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetLongWrongType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
        obj.putElement("a", new JsonString("abc"));
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetLongWrongNumberType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
        obj.putElement("a", new JsonNumber(2.5));
     ...
     */
    @Test
    public void testObjectGetDouble() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetDoubleNoKey() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetDoubleWrongType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
        obj.putElement("a", new JsonString("abc"));
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetDoubleWrongNumberType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
        obj.putElement("a", new JsonNumber(2));
     ...
     */
    @Test
    public void testObjectGetList() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetListNoKey() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetListWrongType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
        obj.putElement("a", new JsonNumber(2));
     ...
     */
    @Test
    public void testObjectGetObject() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetObjectNoKey() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
     ...
     */
    @Test(expected = NoSuchElementException.class)
    public void testObjectGetObjectWrongType() throws NoSuchElementException {
        JsonObject obj = new JsonObject();
        obj.putElement("a", new JsonNumber(2));
